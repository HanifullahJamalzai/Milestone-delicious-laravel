                  ...
                  <form class="row g-3" action="{{ route('ResetPassword') }}" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="password" name="password" class="form-control" id="yourUsername" value="{{ old('email') }}">
                      </div>
                        @error('password')
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Confirm</label>
                      <div class="input-group has-validation">
                        <input type="password" name="password_confirmation" class="form-control" id="yourUsername" value="{{ old('email') }}">
                      </div>
                    </div>
